      ...
      <div id="register" class="modal">
        ...
        <form class="modal-content" method="POST">
          ...
          <div>          
            ...
            <input type="text" placeholder="Gib Vorname ein" name="vn" id="vn" required>
          </div>

          <div>          
            <label for="nn"><b>Nachname</b></label>
            <input type="text" placeholder="Gib Nachname ein" name="nn" id="nn" required>
          </div>

          <div>
            <label for="un"><b>Username</b></label><span></span>
            <input type="text" placeholder="Gib Username ein" name="un" id="un" required>
          </div>
          ...
          <div>
            ...
            <input type="email" placeholder="Gib Email ein" name="email" id="email" required>
          </div>

          <div>
            <label for="telNr"><b>Telefonnummer</b></label><span></span>
            <input type="text" placeholder="Gib Telefonnummer ein" name="telNr" id="telNr" required>
          </div>

          <div>
            <label for="psw"><b>Passwort</b></label>
            <input type="password" placeholder="Gib Passwort ein" name="psw" id="psw" required>
          </div>

          <div>
            <label for="psw-repeat"><b>Passwort wiederholen</b></label><span></span>
            <input type="password" placeholder="Wiederhole das Passwort" name="psw-repeat" id="psw-repeat" required>
          </div>
          <hr>
